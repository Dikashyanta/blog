...
SECRET_KEY = 'django-insecure-gb$ah_+df$$tzl-)8#4*aarv516(u5*ukkjdqi+_b^capk0m8t'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'blogs.contex_processors.get_categories',
                'blogs.contex_processors.get_social_links',
            ],
        },
    },
]
